...
@section('title', 'Manage Budget Reports')
        ...
        <div class="card card-default  p-l-20  p-r-20">
            <div class="card-header separator">
                <div class="card-title">
                    <h5><strong>Manage Budget Reports</strong></h5>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group" style="display: inline-block">
                                <label for="filter_budget_name">Budget Name</label>
                                <input type="text" class="form-control" id="filter_budget_name">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group" style="display: inline-block">
            ...
            <table class="table table-hover table-condensed table-responsive-block table-responsive" id="BudgetReportTable">
                <thead>
                    <tr>
                        {{-- <th style="width: 5%;">#</th> --}}
    ...
    <script>
        ...
        $(document).ready(function(e) {
            ...
            var trans_datatable = table.DataTable({
                ...
                "ajax": {
                    "url": "{{ route('BudgetReports.datatable') }}",
                    "method": "POST",
                    'data': function(data) {
            ...
            $(document).on('keyup', '#filter_budget_name', function() {
