                ...
                <form action="{{ route('admin.users.store') }}" method="post" class="form-control">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <input type="text" id="name" name="name" class="form-control col-md-6" value="{{old('name')}}">
                        </div>
                        <div class="row">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <input type="email" id="email" name="email" class="form-control col-md-6" value="{{old('email')}}">
                        </div>
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <select name="role" id="role" class="form-control col-md-6">
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}" @if(old('role') == $role->id) selected="selected"@endif>{{ $role->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
