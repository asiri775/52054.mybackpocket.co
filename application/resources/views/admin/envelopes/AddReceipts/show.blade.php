...
@section('content')
        ...
        <div class="card card-default">
            <div class="card-header separator">
                <div class="d-flex justify-content-between flex-column flex-md-row">
                    ...
                    <div>
                        <div style="color: #626262 !important; font-size: 1.1rem !important; font-family: Roboto">ID
                            # {{ $transaction->transaction_no }}</div>
                        @if($transaction->payment_ref)
                            <div style="#626262 !important; font-size: 1.1rem !important; font-family: Roboto">Ref
                                # {{ $transaction->payment_ref }}</div>@endif
                    </div>
                </div>
            </div>
                                    ...
                                    @if($transaction->vendor!=null)
                                        <div>
                                            <img class="transaction-logo"
                                                 style="width: 45%; position: relative; left: 50%; transform: translateX(-50%)"
                                                 alt="Logo"
                                ...
                                <div class="table-responsive">
                                    <table class="table m-t-10">
                                        ...
                                        <tr style="background: #626262;">
                                            <th class="text-left" style="color: #fff !important; font-weight: bold;">
                                                ITEM
                                            </th>
                                            <th class="text-center" style="color: #fff !important; font-weight: bold;">
                                                QTY
                                            </th>
                                            <th class="text-right" style="color: #fff !important; font-weight: bold;">
                                                AMOUNT
                                            </th>
                                        </tr>
                                        </thead>
                                                    ...
                                                    <div class="px-4">
                                                        ...
                                                        <ul class="list-group">
                                                            <li class="list-group-item text-left">
                                                                Method: {{ $transaction->payment_method }}</li>
                                                            <li class="list-group-item text-left">Auth Code: -</li>
                                                            <li class="list-group-item text-left">Payment
                                                                Reference: {{ $transaction->payment_ref }}</li>
                                                        </ul>
                                                    </div>
                                                    <div class="px-4">
                            ...
                            <div class="card-header separator">
                                <div class="card-title">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-4">
                                            <a href="{{ route('AddReceipts.mpdf', ['transaction' => $transaction->id]) }}"
                                               class="btn btn-info btn-cons m-b-10 btn-block p-l-10"
    ...
    @include('admin.envelopes.AddReceipts.print')
    </div>
