...
class BathBodyWorks extends VendorInterface
{
    ...
    public function chatGptPrompt()
    {
        ...
        This is receipt of Bath and Body Works
...
Important:- product price is between Custom Amount and Purchase Subtotal
        ...
        1. products, product price given by multiplying with quantity, so in JSON, i need price per item so divide it with quantity
        2. Order date and time is given use that just before amount
        3. Email date
        4. discounts if any
        5. sub total is Purchase Subtotal
        6. tax amount like HST
...
Super Important Note:- order_no is required to be filled in any case
