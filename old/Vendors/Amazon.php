...
class Amazon
{
    ...
    private function setExtraInfo()
    {
        ...
        if ($shipping) {
            ...
            $ex_info[] = [
                ...
                'value' => floatval(str_replace(['CDN', '$'], '', $shipping)),
    ...
    private function setTransaction()
    {
        ...
        if ($sub_total_label_index) {
            $this->sub_total = floatval(str_replace(['CDN', '$'], '', $textArray[$sub_total_label_index + 1]));
        }
        if ($total_label_index) {
            $this->total = floatval(str_replace(['CDN', '$'], '', $textArray[$total_label_index + 1]));
        }
        if ($tax_label_index) {
            $this->tax_amount = floatval(str_replace(['CDN', '$'], '', $textArray[$tax_label_index + 1]));
        }
